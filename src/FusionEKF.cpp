...
FusionEKF::FusionEKF() {
  ...
  // matrix is a 'Jacobian' that is re-evaluated after each prediction step.
  H_laser_ << 1, 0, 0, 0,
             0, 1, 0, 0;
  
  // the initial transition matrix F_
  // This matrix is re-evaluated using delta_t (time gap between two measurements).
  ...
  // Covariance of inherent noise pesent in the process itself. 
  // E.g acceleration noise present when assumed constant speed.
